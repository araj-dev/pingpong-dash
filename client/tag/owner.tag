...
<div class="flex" if={ vis==4 }>
    <div id="pb_flexdiv">
        <div class="pb_result">
            ...
            <div class="bottom">
             <img src="./img/data.png" width="15px" height="auto" onclick={Textshot} id="shot" class="data pointer" style="margin: 0 auto 10px;"><br>
              <span class="button-dropdown" data-buttons="dropdown">
                  <a  onclick={backSelect} class="button button-rounded button-flat-action hover pointer" data-hover="回答を締め切る">
                      <span class="front">{finishedAnswer}/{guestNumber}</span>
                  </a>
              </span>
            </div>
        </div>
